document.addEventListener('DOMContentLoaded', () => {
    ...
    const timerCompleteAudio = document.getElementById('timer-complete-audio'); // Add this line
    ...
    // Update tasklist with countdown timer
    function updateTaskList() {
        ...
        tasks.forEach((task, index) => {
            ...
            const stopButton = taskElement.querySelector('.stop-button'); // Add this line
...
function createCountdownTimer(task, taskElement, index) {
    ...
    let remainingTime = task.duration * 60; // Convert to seconds
    ...
    resetButton.addEventListener('click', () => {
        ...
        remainingTime = task.duration * 60;
        timerInterval = null;
        timerElement.textContent = '${task.duration}:00';
        startButton.disabled = false;
        stopButton.disabled = true;
        resetButton.disabled = true;
        updateTimerDisplay();
